...
export const metadata = {
  ...
  description: "A persistent support ticket / helpdesk queue on CloudGrid, backed by grid-shared Mongo.",
};
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  input, select, textarea { padding: .5rem .75rem; border: 1px solid #8886; border-radius: .5rem; font: inherit; }
  ...
  .prio { font-size: .75rem; padding: .1rem .45rem; border: 1px solid #8886; border-radius: 1rem; }
  .empty { opacity: .6; }
`;
