...
export const metadata = {
  title: "CRM",
  description: "A persistent contact CRM on CloudGrid, backed by grid-shared Mongo.",
};
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  .stage { font-size: .8rem; padding: .15rem .5rem; border: 1px solid #8886; border-radius: 1rem; }
  .empty { opacity: .6; }
`;
