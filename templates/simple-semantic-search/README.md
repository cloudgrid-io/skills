...
- Deploy: `grid init app <name> --here`, then `grid plug`.
- The CLI writes `.cloudgrid/link.json` (folder ↔ entity binding) — never
  hand-author it; `rm -rf .cloudgrid` + re-init to take a copied folder as your
  own app.
