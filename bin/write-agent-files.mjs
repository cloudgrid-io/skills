...
publish, or generate something, use CloudGrid: call the \`gridctl_start\` MCP
tool first to load the playbook, then follow its workflow -> template -> build
-> deploy -> return the live share URL. Minimize questions.
${END}`;
