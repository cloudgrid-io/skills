...
- `gridctl_fetch("template", "appointment-booking")` — the `cloudgrid.yaml` +
...
- Auth + Stripe secrets → `gridctl_secrets` (set the vault items `auth-provider-key`,
